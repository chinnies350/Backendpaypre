...
# client = MongoClient("mongodb://admin:Prematix%40123@172.17.0.19:27017/?authMechanism=DEFAULT")
...
async def get_cursor() -> Cursor:
    # dsn = r'Driver={ODBC Driver 17 for SQL Server};Server={192.168.1.173};Database={PayPre_Common_FrameWork};UID={paypreuser};PWD={password123};MARS_Connection=yes;APP=yourapp'
